...
class FlowerForm(FlaskForm):
    sep_len = TextAreaField('Longeur du sepale')
    sep_wid = TextAreaField('Largeur du sepale')
    pet_len = TextAreaField('Longueur du pétale')
    pet_wid = TextAreaField('Largeur du pétale')

    submit = SubmitField('Prédire la classe')
...
def prediction():
    ...
    content['petal_width'] = float(session['sep_wid'])
